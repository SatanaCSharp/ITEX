...
////        $events = Report::where('company_id',$idCompany)->paginate($itemsPerPage);
////
////        return view('publicPart.manager.reports.index',['reports'=>$reports,'companyId'=>$id,'company'=>$company]);
//    }
    ...
    {
        return view('publicPart.manager.reports.create');
    }
